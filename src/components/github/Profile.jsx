...
class Profile extends Component{
  ...
  render(){
    return (
        ...
        <div className="panel panel-default" key={this.props.userData.id}>
          ...
          <div className="panel-body">
                  ...
                  <div className="row">
                      <div className="col-md-12">
                        <ul className="list-group">
                          ...
                          <li className="list-group-item">Email Address: {this.props.userData.email ||'Null'}</li>
                        </ul>
                      </div>
                  </div>
                  <br/>
            ...
            <RepoList userRepos={this.props.userRepos} id={this.props.userData.id}/>
          </div>
        </div>
